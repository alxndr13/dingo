...
When tasked with building a new foundation for a client, my colleagues and I chose to build on a [custom Go library](https://github.com/lukasjarosch/skipper) inspired by Kapitan (Shoutout to my friend [@lukasjarosch](https://github.com/lukasjarosch) here!). Since it was just a library, we had to add many features and wrap it in a CLI tool to generate: 
